  ...
  return (
    <div>
      <div className="text-center  lg:py-16 p-5   text-white">
        ...
        <p className="text-xl xl:px-56 lg:px-24">
        ...
        <div className="bg-[#D8F7F2] xl:mx-40 lg:py-20 py-5 lg:rounded-[100px] rounded-3xl my-12">
          ...
          <div className="flex xl:justify-center justify-evenly flex-wrap items-center mt-6">
            <div className="lg:w-48 lg:h-36  md:w-48 w-full lg:mx-2  h-32 my-3  flex justify-center items-center">
              <Image
                width={100}
                height={100}
                className="w-20"
            ...
            <div className="lg:w-48 lg:h-36 md:w-48 lg:mx-2 w-full h-32 my-3 flex justify-center items-center ">
              <Image
                width={100}
                height={100}
                className="w-20"
            ...
            <div className="lg:w-48 lg:h-36 md:w-48 lg:mx-2 w-full h-32 flex justify-center items-center ">
              <Image
                width={100}
                height={100}
                className="w-20"
            ...
            <div className="lg:w-48 lg:h-36 md:w-48 lg:mx-2 w-full my-3 h-32 flex justify-center items-center ">
              <Image
                width={100}
                height={100}
                className="w-20"
